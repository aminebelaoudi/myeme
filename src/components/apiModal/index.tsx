          ...
          <Card textAlign={'center'}>
            ...
            <ModalBody p="0px">
              <Text
                ...
                mb="22px"
              >
                You need a Gemini API Key to use Horizon AI Template's
              ...
              <Flex mb="20px">
                ...
                <Button
                  ...
                  h="54px"
                  onClick={() => {
                    inputCode?.includes('AIzaSy')
                      ? handleApiKeyChange(inputCode)
                      : null;
                    if (inputCode)
                      toast({
                        title: inputCode?.includes('AIzaSy')
                        ...
                        position: 'top',
                        status: inputCode?.includes('AIzaSy')
                          ? 'success'
                          : !inputCode?.includes('AIzaSy')
                          ? `error`
                          : !inputCode
                  ...
                  <AccordionPanel p="18px 0px 10px 0px">
                    <UnorderedList p="5px">
                      ...
                      >
                        ...
                        and a valid API key to use Gemini. We don't sell API
                        keys.
                      </ListItem>
                      <ListItem
                        color={grayColor}
                        ...
                        fontWeight="500"
                      >
                        Make sure you have enabled the Gemini API in your{' '}
                        <Link
                          textDecoration="underline"
                          fontSize="md"
                          lineHeight="28px"
                        ...
                        and have billing set up. Without billing info, your API key will not work.
                      </ListItem>
                    </UnorderedList>
                  </AccordionPanel>
                </AccordionItem>
              ...
              <Text
                ...
                mx="30px"
              >
                *The app will connect to Gemini API server to check if your API
